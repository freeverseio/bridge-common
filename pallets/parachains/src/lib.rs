...
pub mod pallet {
    ...
    impl<T: Config<I>, I: 'static> Pallet<T, I> {
        ...
        ) -> Result<Option<HeaderIdOf<C>>, parity_scale_codec::Error> {
        ...
        pub(super) fn update_parachain_head(
            ...
            let next_imported_hash_position = stored_best_head.map_or(0, |stored_best_head| {
            ...
            Ok(UpdateParachainHeadArtifacts {
                best_head: updated_best_para_head,
                prune_happened,
            })
        }
    }
